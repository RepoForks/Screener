...
public class PreferenceManagerCompat {
    ...
    static void setOnPreferenceTreeClickListener(PreferenceManager manager, final OnPreferenceTreeClickListener listener) {
        try {
            ...
            if (listener != null) {
                onPreferenceTreeClickListener.set(manager, Proxy.newProxyInstance(onPreferenceTreeClickListener.getType().getClassLoader(), new Class[]{onPreferenceTreeClickListener.getType()}, new InvocationHandler() {
