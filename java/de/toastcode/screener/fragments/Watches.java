...
*/
    ...
    L_0x00f7:
        throw r5;
        */
        throw new UnsupportedOperationException("Method not decompiled: de.toastcode.screener.fragments.Watches.selectFromDB(java.lang.String):void");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.startDownload.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Watches.this.startActivity(new Intent(Watches.this.getActivity(), Choose_CompanyActivity.class));
            }
        });
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        ((SearchView) MenuItemCompat.getActionView(menu.findItem(R.id.action_search))).setOnQueryTextListener(new OnQueryTextListener() {
            public boolean onQueryTextSubmit(String query) {
                Watches.this.mAdapterGrid.filter(query);
                return true;
            }

            public boolean onQueryTextChange(String newText) {
                Watches.this.mAdapterGrid.filter(newText);
                return true;
            }
        });
    }
