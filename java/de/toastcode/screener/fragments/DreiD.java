...
public class DreiD extends Fragment {
    Cursor c;
    Database_Helper dbh;
...
*/
    ...
    L_0x00f7:
        throw r5;
        */
        throw new UnsupportedOperationException("Method not decompiled: de.toastcode.screener.fragments.DreiD.selectFromDB(java.lang.String):void");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.startDownload.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                DreiD.this.startActivity(new Intent(DreiD.this.getActivity(), Choose_CompanyActivity.class));
            }
        });
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        ((SearchView) MenuItemCompat.getActionView(menu.findItem(R.id.action_search))).setOnQueryTextListener(new OnQueryTextListener() {
            public boolean onQueryTextSubmit(String query) {
                DreiD.this.mAdapterGrid.filter(query);
                return true;
            }

            public boolean onQueryTextChange(String newText) {
                DreiD.this.mAdapterGrid.filter(newText);
                return true;
            }
        });
    }
